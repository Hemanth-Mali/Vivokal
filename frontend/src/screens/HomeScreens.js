        ...
        <>
         <Meta title='Home' />
            <section  style={{textAlign:'center'}}>
               <Row>
                   <Col sm={12} >  
                    <Image style={{width:'450px'}} roundedCircle src="/images/logo.jpeg"  fluid/>
                   </Col>
               </Row>
...
Continuing our push to be #VocalForLocal,<bold> Vivokal </bold>is paying ode to remarkable local entrepreneurs that are promoting Indian sensibilities through mediums of arts, handicrafts, services and food.
                    </p>
                </div>
            </section>
            <br />
           ...
           <br/>
             ...
             <Carousel style={{padding:'5%'}}>
                ...
                <Carousel.Item as="div" style={{padding:'5%'}}>
                   ...
                   <Image roundedCircle style={{width:'150px'}} src="/images/hemanth.jpeg" alt="Hemanth" />
                   <br />
                   <br />
                   <br />
                   <h5 style={{color:'#fff'}}>Hemanth Mali</h5>
                </Carousel.Item>
               <Carousel.Item as="div" style={{padding:'5%'}} >
                   ...
                   <Image roundedCircle style={{width:'150px'}} src="/images/shanti.jpeg" alt="Shanti" />
                   <br />
                   <br />
                   <br />
                   <h5 style={{color:'#fff'}}>Shanthi Sree</h5>
                </Carousel.Item>
               <Carousel.Item as="div" style={{padding:'5%'}}>
                    <h3 style={{color:'#fff'}}>“Money spent locally stays local, Environmentally better and Backbone of any town or city.”</h3>
                    <Image roundedCircle style={{width:'150px'}} src="/images/surya.jpg" alt="Surya" />
                    <br />
                   <br />
                   <br />
                    <h5 style={{color:'#fff'}}>Surya Rapo</h5>
                    </Carousel.Item>
                </Carousel>    
                <br />    
           </section>
           ...
           <br />
            ...
            <section style={{textAlign:'center'}}> 
                ...
                <p style={{fontSize:'25px'}}><a href='mailto:vivokalvizag@gmail.com'>vivokalvizag@gmail.com</a></p>
            </section>
